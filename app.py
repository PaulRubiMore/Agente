...
def programar_36h(df: pd.DataFrame, riesgo_thr: int = 4) -> pd.DataFrame:
    """
    Programa todas las actividades dentro de 36 horas, priorizando score y nivelando recursos.
    """
    HORIZONTE = 36
